...
However, crime rates across all subtypes began to rise again after 2020 as seen by the increasing numbers of victims across all subtypes, age groups, and genders. The number of youth and child victims also demonstrate upward trends in the new decade. Even though recent improvements in data collection methods show positive progress in identifying victims more accurately, public safety is still facing an increasing number of challenges. Based on the data-driven results, we are centainly not confident enough to claim significant progress for the public safety in the Toronto communities.
